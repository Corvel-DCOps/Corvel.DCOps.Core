#
# Module manifest for module 'PSGet_Corvel.DCOps.Core'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/Corvel-DCOps/Corvel.DCOps.Core/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/Corvel-DCOps/Corvel.DCOps.Core'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/Corvel-DCOps/Corvel.DCOps.Core/blob/main/README.md'
