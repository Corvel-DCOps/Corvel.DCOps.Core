$script:DCOpsLogLevels = @('VERBOSE', 'INFORMATION', 'WARNING', 'ERROR', 'NONE')
$script:DCOpsFileLogLevelDefault = 'INFORMATION'
$script:DCOpsVRLILogLevelDefault = 'VERBOSE'
$script:DCOpsLogPathDefault = "$($env:ProgramData)\Corvel.DCOps\log"
